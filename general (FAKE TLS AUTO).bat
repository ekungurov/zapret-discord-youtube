...
start "zapret: %~n0" /min "%BIN%winws.exe" --wf-tcp=80,443,8443 --wf-udp=443,50000-50100,%GameFilter% ^
...
--filter-tcp=443,8443 --hostlist="%LISTS%list-general.txt" --dpi-desync=fake,multidisorder --dpi-desync-split-pos=1,midsld --dpi-desync-repeats=11 --dpi-desync-fooling=md5sig --dpi-desync-fake-tls-mod=rnd,dupsid,sni=www.google.com --new ^
